...
<body>
    ...
    <div class="blog-page default-page service-page clearfix">
        ...
        if ($_SESSION['logedin']) {
          $find = $_POST['look'];
          $sel = "SELECT * FROM signup WHERE patnum = '$patnum'";
          $suc = $conn->query($sel);
          if ($suc->num_rows > 0) {
              ...
              <div class="col-lg-9 col-md-8">
                <div  class="same" >
                    <p style="text-align: center; font-size: 16pt;color: black;" >Dear <b style="color: red;" ><?php $col = $name." ".$last; echo $col; ?></b> you can update your profile here  </p>
                </div>
                <div>&nbsp;</div>
                <form method="POST" action="record.php" >
                    <div class="col-md-6" >
                        <label>First Name</label>
                        <input type="text" name="first"  value="<?php  echo $name; ?>" placeholder="" required=""  >

                        <label>Email</label>
                        <input type="text" name="email"  value="<?php echo $email ?>"  placeholder="" required=""  >

                        <label>Phone</label>
                        <input type="text" name="phone" value="<?php echo $phone;  ?>"  placeholder=""  >
                        <label>State</label>
                        <input type="text" name="state" value="<?php echo $state;  ?>"  placeholder=""  >
                    </div>
                    <div class="col-md-6" >
                        <label>Last Name</label>
                        <input type="text" name="lname" value="<?php echo $last; ?>" title="lastname cannot be edtited" placeholder=""  required="" readonly >

                        <label>D.o.b</label>
                        <input type="text" name="dob"  value="<?php echo $dob; ?>"  placeholder="" required=""  >

                        <label>Address</label>
                        <input type="text" name="address" value="<?php echo $address; ?>"  placeholder="" required=""  >
                        <label>City</label>
                        <input type="text" name="home" value="<?php echo $home; ?>"  placeholder="" required=""  >
                    </div>

                    <input type="text" style="display: none;" value="<?php echo $patnum; ?>" name="pnum">
                    <!-- <input type="submit" name="del" value="Delete Your Account"  style="float: left;margin-left: 2%;" > -->
                    <input type="submit" name="submit" value="Update"  style="float: right;margin-right: 2%;" >
                </form>
            </div>
            <?php
        }else{
