    ...
    <!-- Define a viewport to mobile devices to use - telling the browser to assume that the page is as wide as the device   the page is as wide as the device (width=device-width)
                    ...
                    <aside class="sidebar clearfix">
                        ...
                        <section id="categories-4" class="widget widget_categories">
                            ...
                            <ul>
                                ...
                                <li><a href="history.php" >View Medical History</a></li>
                                <li><a href="delete.php" title="View all posts filed under Lifestyle">Delete A User</a></li>
                ...
                if ($_SESSION['logedin']) {
                  ...
                  if ($suc->num_rows > 0) {
                      ...
                      <div class="col-lg-9 col-md-8">
                        <div  class="same" >
                            <p style="text-align: center; font-size: 16pt;color: black;" >Dear <b style="color: red;" ><?php $col = $name." ".$last; echo $col; ?></b>  click Delete to delete your account</p>
                        </div>
                        <div>&nbsp;</div>
                        <form method="POST" action="record.php" >
                            ...
                            <input type="submit" name="delete" value="Delete Account"  style="float: right;margin-right: 2%;" >
                        </form>
                    </div>
                    <?php
                }else{
