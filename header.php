    ...
    <div class="container">
        ...
        <nav class="main-menu">
            <ul class="header-nav clearfix" id="menu-main-menu">
                ...
                <li>
                    <a href="doctors-four-columns.php">Doctors</a>
                </li>
                <li>
                    <a href="services-one-columns.php">Services</a>
                </li>
                <li>
                    <a href="gallery-three-columns.php">Gallery</a>
                </li>
                <li>
                ...
                <li>
                 ...
                 <li>
                    <a href="" data-toggle="modal" data-target="#modalLRForm" >Login</a>
                </li>
                <li>
