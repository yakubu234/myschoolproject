                ...
                <div class="col-lg-3 col-md-4">
                    <aside class="sidebar clearfix">
                        ...
                        <section id="categories-4" class="widget widget_categories">
                            ...
                            <ul>
                                <li><a href="signadmin.php" title="View all posts filed under Environment">Add Admin</a></li>
                                <li><a href="signup.php" title="View all posts filed under Health Basics">Add Medical Practitioner</a></li>
                  ...
                  if ($suc->num_rows > 0) {
                      ...
                      <div class="col-lg-9 col-md-8">
                        ...
                        <form method="POST" action="record.php" >
                            ...
                            <input type="submit" name="delete" value="Delete User"  style="float: right;margin-right: 2%;" >
                        </form>
                    </div>
                    <?php
                }else{
