...
if ($mail === $email) {
 ...
 alert('email already exist');
   ...
   $ins = "INSERT INTO signup VALUES (null,'$fname','$lname','$email','$pnum','$phone','$address','$hashed_password','$dob','$state','$home','admin',null )";
...
<head>
    ...
    <!-- Define a view port to mobile devices to use - telling the browser to assume that  the page is as wide as the device (width=device-width)
                                            ...
                                            <div class="col2-set" id="customer_details">
                                                <div class="col-1">
                                                    <div class="woocommerce-billing-fields">
                                                        ...
                                                        <h3>Billing Details for Admin</h3>
