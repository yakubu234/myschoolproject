...
if ($mail === $email) {
 ...
 alert('email already exist');
   ...
   $ins = "INSERT INTO signup VALUES (null,'$fname','$lname','$email','$pnum','$phone','$address','$hashed_password','$dob','$state','$home','patient',null )";
                        ...
                        <div class="full-width-contents">
                            <div class="entry-content">
                                <div class="woocommerce">
                                    <div class="woocommerce-info">Returning user ? <a href="#" class="showlogin error">Click here to login</a></div>

                                    <form method="POST" action="login.php" class="login" style="display:none;">


                                        <p>If you have partner with us before, please enter your details in the boxes below. If you are a new customer, please proceed to the Billing &amp; Shipping section.</p>

                                        <p class="form-row form-row-user">
                                        ...
                                        <p class="form-row form-row-user2">
                                            <label for="password" class="error" >User type <span class="required">*</span></label>
                                            <select name="gender" id="billing_state" class="state_select "  data-placeholder=""  ><option>Select user type</option></select>
                                        </p>
                                        <div class="clear"></div>

                                        <p class="form-row">
                                            <label for="rememberme" class="inline">
                                                <a href="#" id="rememberme" class="error" >Lost your password?</a>  </label>
                                                <input type="submit" style="float: right;" class="button" name="login" value="Login">
